        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <span
                className="flex h-10 w-10 items-center justify-center rounded-2xl text-[#00F0FF]"
                style={{
          ...
          <div className="mt-5 rounded-2xl border border-[#00F0FF]/30 bg-gradient-to-br from-[#00F0FF]/15 via-white/[0.03] to-[#7000FF]/15 p-5">
            ...
            {user.role === 'driver' && (
              <div className="mt-3 flex items-center justify-between border-t border-white/10 pt-3 text-[11px]">
                ...
                <span className="font-bold text-[#3DFFC2]">88% Net ({usd(user.todayEarnings)})</span>
              </div>
            )}
          </div>
          ...
          {successToast && (
            <motion.div
              ...
              className="mt-3 flex items-center gap-2 rounded-xl border border-[#3DFFC2]/40 bg-[#3DFFC2]/10 p-2.5 text-[12px] font-bold text-[#3DFFC2]"
            >
            ...
            <div className="mt-2 grid grid-cols-3 gap-2">
              {[25, 50, 100].map((amt) => (
                <button
                  ...
                  className="flex items-center justify-center gap-1 rounded-xl border border-[#00F0FF]/30 bg-white/[0.04] py-2.5 text-[13px] font-bold text-white transition-all hover:border-[#00F0FF] hover:bg-[#00F0FF]/10 active:scale-95"
                >
                  <Plus size={14} className="text-[#00F0FF]" /> +${amt}
                </button>
              ))}
            </div>
          </div>
            ...
            <div className="mt-2 flex flex-col gap-2">
              <div className="flex items-center justify-between rounded-xl border border-white/8 bg-white/[0.03] p-3">
                <div className="flex items-center gap-3">
                  <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#3DFFC2]/15 text-[#3DFFC2]">
                ...
                <span className="text-[13px] font-bold text-[#3DFFC2]">+$50.00</span>
              </div>

              <div className="flex items-center justify-between rounded-xl border border-white/8 bg-white/[0.03] p-3">
                <div className="flex items-center gap-3">
                  <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#00F0FF]/15 text-[#00F0FF]">
